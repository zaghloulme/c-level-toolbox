...
|-------|------------|---------|
| **Content types** | "What content does your organization produce? Blog, social, email, reports?" | No default — list all types |
| **AI usage level** | "How much of your content involves AI? All, most, some, or experimenting?" | Some — growing |
| **Team structure** | "Who creates and reviews content?" | No default — must be provided |
...
- [ ] Organizational perspective is woven in where appropriate
...
- [ ] Images are original or properly licensed
```
...
- Input confidential data into AI tools without consent
...
- Share the policy with anyone who creates content for the organization
...
**Organization:** Marketing agency producing blog content for clients
...
- **Under-disclosing** — claiming full human authorship for AI-generated content erodes trust when discovered.
...
- **Audience reacts negatively to AI disclosure:** Emphasize human oversight. Audiences care about quality and honesty, not the tools used.
