...
| **Target customer** | "Who is the ideal buyer? (company size, budget level, sophistication)" | Must be provided |
| **Competitor prices** | "What do competitors charge for similar offerings?" | Unknown — will request |
...
|------|-------|----------|-------------|
| [Starter] | $[X] | [Core features] | Price-sensitive buyers |
| [Professional] | $[X] | [Core + advanced] | Most buyers (anchor here) |
| [Enterprise] | $[X] | [Everything + extras] | Large accounts, power users |
```
Best for: SaaS, consulting packages, managed services
...
## Example: B2B Professional Services Pricing

**Context:** Management consulting firm, $8,000 cost to deliver a 4-week engagement.
**Value delivered:** Clients typically reduce costs by $250K or accelerate revenue by $400K.
**Competitors:** $25K-$80K for comparable scope.

**Recommendation:** $45,000 single engagement or $28K/$45K/$75K three-tier structure. Middle tier at $45K captures ~10% of value delivered. Premium tier at $75K adds implementation support and a 6-month check-in. Price point positions firmly mid-market, above commodity vendors, below top-tier firms.

## Anti-Patterns

- **Cost-plus only pricing** — your costs are irrelevant to the buyer. Price on value delivered.
