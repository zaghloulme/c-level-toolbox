...
|-------|------------|---------|
| **Product/service** | "What are you selling? Describe it in one sentence." | No default — must be provided |
| **Target customer** | "Who is your ideal buyer? (demographics, company size, industry)" | No default — must be provided |
| **Geography** | "What market? (US, North America, global, specific country)" | United States |
| **Pricing** | "What is your price point or expected annual revenue per customer?" | No default — must be provided |
...
- [ ] SOM is realistic (under 5% of SAM for most early-stage businesses)
- [ ] No obviously inflated numbers designed to impress rather than inform

## Example 1: B2B Workforce Management Tool (US market)

**TAM:** US workforce management software market = $8.4B annually. 6M businesses with 10+ employees as potential buyers.
**SAM:** Mid-market companies (50-500 employees) actively evaluating software = ~180,000 companies at $600-1,200/year = $108M-$216M.
**SOM:** Targeting distributed-workforce segment specifically = ~40,000 addressable. At 0.5% capture rate in Year 1 = 200 customers × $900/yr = $180K ARR.

## Example 2: Local Service Business (city-level market)

**TAM:** 500,000 households in metro area × $500/year avg spend on service = $250M
**SAM:** 50,000 target-income households × $500 = $25M
**SOM:** 2% market share in Year 1 = 1,000 customers × $500 = $500K
