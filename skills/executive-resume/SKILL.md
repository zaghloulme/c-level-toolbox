...
Example:
"Operations executive with 15 years of experience scaling companies from startup
to $50M+ in revenue. Built and led teams of 80+ across 4 departments. Known for
building systems that reduce operational costs while improving customer retention.
Seeking a VP Operations role at a growth-stage company."
```
...
Examples:
- "Spearheaded digital transformation initiative across 4 departments, reducing
  manual processes by 60% and saving $1.2M annually"
- "Built and scaled a customer success team from 3 to 22, improving retention
  from 78% to 94% in 12 months"
...
```
## VP of Marketing | TechScale Inc. | 2020 – Present
B2B company, $15M ARR, 120 employees
...
- Launched ABM program targeting enterprise accounts, closing $2.1M in deals in year one
...
```
## Chief Operating Officer | GrowthWorks LLC | 2018 – Present
Operations consulting firm serving mid-market companies, $4M revenue
...
- **Cannot quantify achievements:** Use directional metrics ("increased by approximately 30%") or scope metrics ("managed $2M budget"). Even estimates beat no numbers.
- **Gaps in employment:** Address briefly — consulting, advisory work, education, or other projects. Gaps are less concerning for executives than for entry-level roles.
- **Changing industries:** Lead with transferable achievements (revenue growth, team building, process improvement). Minimize industry-specific jargon from the previous industry.
- **Long tenure at one company:** Break into 2-3 entries showing progression (promotions, expanded scope). Demonstrate growth within the organization.
