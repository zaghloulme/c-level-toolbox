...
1. Confirm the organization's business, product/service, and current reach (audience size, revenue range, customer count)
...
4. Clarify what your organization wants from the partnership (leads, revenue, credibility, reach)
5. Clarify what you can offer the partner (same categories)
...
8. Identify the "unfair advantage" — the one thing that makes this partnership uniquely valuable versus alternatives
...
Organizations consistently report that project management and time tracking
are two of their biggest operational pain points — yet they use separate
tools that don't communicate. By partnering, we can own the "complete
operations stack" positioning that neither of us can claim alone.
...
- Co-authored "Team Productivity Report" generating backlinks
...
Month 2: Co-create lead magnet ("2025 Team Productivity Report")
...
```
Subject: TaskPilot x ClockIn — operations stack partnership

Hi Dana,

Quick idea: TaskPilot (project management) + ClockIn (time tracking)
as a bundled operations platform.
...
- Co-branded lead magnet targeting distributed teams
...
## Example 2: Agency Referral Partnership

**Context:** A brand design firm wants to partner with a copywriting agency for mutual referrals.
...
Our client bases overlap precisely: organizations that invest in professional
branding almost always need website copy, and those investing in copy need
visual brand identity. Right now, we're both leaving opportunity on the
table by not having a go-to referral partner.
...
Let's schedule a call next week to map out:
...
- If the organization cannot quantify their audience or assets, help them estimate using available data (email list size, social followers, monthly revenue)
...
- If the partnership type is unclear, default to a non-exclusive co-marketing arrangement — lowest risk, easiest to start
- If the partner declines, request feedback and revise the proposal for the next target
...
- Do not propose exclusivity unless explicitly requested — default to non-exclusive
