...
COMPENSATION IS A STRATEGY, NOT A REACTION — A CLEAR PAY PHILOSOPHY ATTRACTS THE RIGHT PEOPLE, RETAINS TOP PERFORMERS, AND PREVENTS PAY DECISIONS BASED ON WHO NEGOTIATES HARDEST.
...
|-------|------------|---------|
| **Roles to compensate** | "What roles are you designing compensation for?" | No default — must be provided |
| **Organization stage** | "What stage? (growth, mature, restructuring)" | Growth |
| **Budget** | "What is your total compensation budget?" | No default — must be provided |
| **Hiring market** | "Where are you hiring from? (local, national, global)" | National |
| **Current pay** | "What are you paying now for similar roles?" | No default — must be provided |
| **Talent competition** | "Who are you competing with for talent?" | Industry peers and adjacent sectors |
...
**Note:** Contractor rates should be 25-40% higher than employee equivalent to account for no benefits, self-employment taxes, and variable engagement.
```
...
- Peer organization conversations
...
- Are there gaps correlated with demographics or tenure?
...
- **All base, no variable** — variable pay aligns incentives. All-fixed pay does not.
- **Secret compensation** — opacity breeds distrust. At minimum, share the band structure.
- **Comparing contractor and employee rates directly** — contractors cost more per hour but less in total (no benefits, overhead).

## Recovery

- **Cannot afford market rates:** Compensate with flexibility (remote, hours), equity, profit sharing, or accelerated growth opportunities. Be transparent about the trade-off.
...
- **No idea what market rate is:** Use 3+ free salary data sources and average them. Imperfect data beats no data.
