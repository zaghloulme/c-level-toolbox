...
|-------|------------|---------|
| **Profile goal** | "What do you want your profile to attract? (clients, job offers, partnerships, speaking)" | Inbound opportunities |
...
Example: "I help companies double their pipeline through content | Former Head of Growth at 2 category leaders"

Formula 2: [What you do] for [who] | [Proof point]
Example: "Operations Strategy for Growing Organizations | Helped 50+ companies build scalable systems"

Formula 3: [Title] | [Outcome you deliver] | [Keyword]
Example: "Fractional CMO | Revenue Growth for B2B Companies | Demand Generation"
```
...
```
Headline: "I help B2B companies build content engines that generate pipeline | $12M+ in client revenue attributed to content"

About (opening): "Your team is producing posts, blogs, and newsletters. But your pipeline is flat.

That's because most B2B content is built for engagement, not revenue. I fix that.

Over the last 5 years, I've helped 40+ companies turn their content into a consistent pipeline driver. The results: $12M+ in attributed revenue, 3x average increase in inbound leads, and content systems that keep working long after our engagement ends."
```

### Example 2: Executive Job-Seeking Profile

```
Headline: "VP Operations | Scaled 3 companies from startup to $50M+ | Building teams and systems that grow"

About (opening): "I build the operational backbone that lets companies scale without breaking.

Three times, I've taken a growing organization with strong leadership and chaotic operations and turned it into a machine — systems that scale, teams that perform, and costs that stay under control.

The results: $50M+ in combined revenue, 200+ employees hired and developed, 40% average reduction in operational costs."
```
...
- **Generic skills list** — outdated or irrelevant skills do not differentiate you. Prioritize skills that match your keyword strategy.
- **No recommendations** — recommendations from credible contacts are social proof. Ask for them actively.

## Recovery

- **No achievements to highlight:** Focus on scope (team size, budget, projects) and qualitative impact (what changed because of your work).
...
- **Niche industry:** Use industry-specific keywords heavily. In niche markets, keyword specificity matters more than broad appeal.
- **No professional headshot:** Take a well-lit smartphone photo against a plain background. Dress professionally, look at the camera, crop from chest up.
