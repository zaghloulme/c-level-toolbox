...
### Example 1: Business/Leadership Talk

```
Idea: "The most effective leaders don't work harder — they build systems that work without them"
Hook: "Last quarter, my best-performing division ran without a single decision from me. Here's what I changed."
Problem: The assumption that leadership means being the bottleneck for every decision
Insight: Decision architecture replaces individual judgment at scale
Proof: Three case studies of leaders who delegated decision rights and saw performance improve
Call: "This month, identify one decision only you are making that someone else could own."
```

### Example 2: Personal Development Talk

```
Idea: "Saying no is the most productive thing you will ever do"
Hook: Story of saying yes to everything and ending up with nothing moving forward
Problem: We are taught that opportunity equals obligation
Insight: Strategic no's create space for the right yes's
Proof: Research on decision fatigue + case of an executive who tripled output by cutting commitments
Call: "The next time someone asks you for something, pause. Ask: does this serve the mission? If not, say no."
```
...
- **Ending with "Thank you"** — end with your closing line. Adding "thank you" as a filler kills the final moment.

## Recovery

- **Idea is too broad:** Ask "What is the ONE thing you want the audience to remember a week later?" Narrow to that.
- **No personal story:** Ask "When did you first realize this idea was true? What happened?" That moment IS the story.
- **Talk runs too long:** Cut the weakest story or example. Do not speed up — cut content.
- **Speaker is terrified of public speaking:** Focus on telling stories to one person in the audience, not presenting to a crowd. Practice in low-stakes settings first.
